...
- **27 solid color presets:** Catppuccin, Nord, Dracula, Tokyo Night, Gruvbox, Rose Pine, Kanagawa, and more
- **12 gradient presets:** Dark Nebula, Cosmic, Northern, Ocean Deep, Purple Haze, and more
- **Tile customization:** Icon size, column count, and gap sliders
- **Full backup export / import:** Save and restore your tiles, theme, and layout as a single JSON file; selective import lets you choose what to bring in
